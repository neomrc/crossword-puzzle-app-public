const CACHE="crossword-quest-public-v16";
const ASSETS=["./","./index.html","./styles.css","./native-enhancements.css","./puzzle-seed.js","./app.js","./app-enhancements.js","./manifest.webmanifest","./icons/icon.svg"];
