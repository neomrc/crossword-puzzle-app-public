const CACHE="crossword-quest-public-v13";
const ASSETS=["./","./index.html","./styles.css","./native-enhancements.css","./app.js","./app-enhancements.js","./manifest.webmanifest","./icons/icon.svg"];
