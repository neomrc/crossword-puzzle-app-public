const CACHE="crossword-quest-public-v21";
const ASSETS=["./","./index.html","./styles.css","./native-enhancements.css","./puzzle-seed.js","./app.js","./app-enhancements.js","./interaction-guard.js","./manifest.webmanifest","./icons/icon.svg"];
