const CACHE="crossword-quest-public-v18";
const ASSETS=["./","./index.html","./styles.css","./native-enhancements.css","./puzzle-seed.js","./app.js","./app-enhancements.js","./keyboard-controller.js","./manifest.webmanifest","./icons/icon.svg"];
